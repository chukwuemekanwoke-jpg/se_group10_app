...
The develop branch is simply the branch where all active code and features live. It contains only:
1. all working project code
2. full application features
3. in-progress feature updates
4. integration work
5. testing before promoting to main
